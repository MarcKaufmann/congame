...
@inline-note{See a @secref["multi-participant-tutorial"] to learn how this study works.}
...
@section{Multi-participant Study: Proposals}

@inline-note{See source in @github-link{congame-example-study/proposal-choice.rkt}.}
